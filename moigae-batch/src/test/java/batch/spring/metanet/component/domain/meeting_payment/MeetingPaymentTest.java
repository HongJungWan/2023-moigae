...
class MeetingPaymentTest {
    ...
    @Test
    @DisplayName("MeetingPayment equals and hashCode 테스트")
    void 모임_결제_equals_HashCode_테스트() {
        //given
        MeetingPayment meetingPaymentOne = createMeetingPayment();
        MeetingPayment meetingPaymentTwo = createMeetingPayment();

        //when & then
        assertThat(meetingPaymentOne).isEqualTo(meetingPaymentTwo);
        assertThat(meetingPaymentOne).hasSameHashCodeAs(meetingPaymentTwo);
    }
